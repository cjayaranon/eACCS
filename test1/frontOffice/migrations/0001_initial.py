    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('NE', 'N/A')], max_length=6)),
                ('civilStatus', models.CharField(choices=[('SI', 'Single'), ('MA', 'Married'), ('WI', 'Widowed'), ('LS', 'Legally Separated')], max_length=20)),
                ...
                ('mailingAddress2', models.TextField(blank=True, default='')),
